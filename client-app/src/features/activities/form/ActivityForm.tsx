...
export default observer(function ActivityForm() {
  ...
  const [activity, setActivity] = useState<Activity>({ id: "", title: "", category: "", description: "", date: null, city: "", venue: "" });

  const validationSchema = Yup.object({
    title: Yup.string().required("The activity title ist required"),
    description: Yup.string().required("The activity description ist required"),
